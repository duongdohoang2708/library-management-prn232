...
namespace LibraryManagement.DAL.Migrations
{
    ...
    [Migration("20260628134318_AddRenewalRequests")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryManagementDAL.Models.AuditLog", b =>
                {
            ...
            modelBuilder.Entity("LibraryManagementDAL.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            PublishYear = 1937,
                            PublisherId = 10,
                            Title = "Vụ án mạng dòng sông Nile"
                        },
                        new
                        {
                            BookId = 19,
                        ...
                        new
                        {
                            ...
                            PublishYear = 1865,
                            PublisherId = 8,
                            Title = "Từ Trái Đất lên Mặt Trăng"
                        },
                        new
                        {
                            BookId = 23,
                        ...
                        new
                        {
                            ...
                            PublishYear = 1992,
                            PublisherId = 6,
                            Title = "Phía Nam biên giới, phía Tây mặt trời"
                        },
                        new
                        {
                            BookId = 25,
            ...
            modelBuilder.Entity("LibraryManagementDAL.Models.ReminderLog", b =>
                {
                    ...
                    b.HasIndex("BorrowDetailId", "ReminderType", "ReminderDate")
                        .IsUnique();

                    b.ToTable("ReminderLogs");
                });

            modelBuilder.Entity("LibraryManagementDAL.Models.RenewalRequest", b =>
                {
                    b.Property<int>("RenewalRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RenewalRequestId"));
                    ...
                    b.Property<int>("RequestedExtraDays")
                        .HasColumnType("int");
                    ...
                    b.HasKey("RenewalRequestId");

                    b.HasIndex("ReviewedByUserId");

                    b.HasIndex("UserId");

                    b.HasIndex("BorrowDetailId", "Status");
            ...
            modelBuilder.Entity("LibraryManagementDAL.Models.SystemSetting", b =>
                {
            ...
            modelBuilder.Entity("LibraryManagementDAL.Models.RenewalRequest", b =>
                {
                    ...
                    b.HasOne("LibraryManagementDAL.Models.Account", "ReviewedBy")
                        .WithMany()
